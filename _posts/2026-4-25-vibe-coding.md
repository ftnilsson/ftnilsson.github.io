...
![Josh Seiden's book "Outcomes over Outputs"](/images/vibe_code.jpg)
...
*Vibe Coding* is a must-read for any practising software engineer right now. It's not always comfortable, but it's honest — and the head chef framing alone is worth your time. If you've read my earlier post on [Deep Work]({% post_url 2025-04-21-Deep-Work %}), the connection is natural: the focused, high-quality thinking that Cal Newport describes is exactly what separates a head chef who runs the kitchen from one who just hopes it runs itself.
...
- [Buy on Amazon](https://www.amazon.com/Vibe-Coding-Building-Production-Grade-Software/dp/1966280025)
- ISBN: 978-1966280026
